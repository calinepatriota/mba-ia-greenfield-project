...
import { CreateVideos1782482885893 } from './migrations/1782482885893-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  afterAll(async () => {
    // The revert test undoes the last migration, leaving the videos table missing.
  ...
  it('should create videos with a foreign key to channels', async () => {
